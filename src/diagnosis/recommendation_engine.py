...
class RecommendationEngine:
    ...
    @staticmethod
    def get_recommendations(category: FailureCategory, context: Dict[str, Any]) -> List[str]:
        """
    ...
    def _recommend_quality_failure(context: Dict[str, Any]) -> List[str]:
        ...
        if root_cause == "body_too_short":
            ...
            recommendations.extend(
                ["제목 CSS Selector를 확인하세요", "UC2 Self-Healing이 자동으로 수정을 시도합니다"]
            )
    ...
    @staticmethod
    def format_recommendations_html(recommendations: List[str], title: str = "💡 해결 방법") -> str:
        """
